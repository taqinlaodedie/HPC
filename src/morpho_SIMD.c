...
void morpho_SIMD_pipeline(vuint8 **img_src, vuint8 **erosion1, vuint8 **dilatation1, vuint8 **dilatation2, vuint8 **img_dst, int m, int n)
{
	...
	for (i = 3; i < m; i++) {
		...
		// Dilatation 1
		d1c0 = _mm_load_si128((vuint8 *)&erosion1[i][-1]);
		d1c1 = _mm_load_si128((vuint8 *)&erosion1[i][0]);
		for (j = 0; j < n; j++) {
			d1a2 = _mm_load_si128((vuint8 *)&erosion1[i-2][j+1]);
			d1b2 = _mm_load_si128((vuint8 *)&erosion1[i-1][j+1]);
			d1c2 = _mm_load_si128((vuint8 *)&erosion1[i][j+1]);
			...
			_mm_store_si128((vuint8 *)&dilatation1[i-1][j], s);
		...
		d2c1 = _mm_load_si128((vuint8 *)&dilatation1[i-1][0]);
		for (j = 0; j < n; j++) {
			d2a2 = _mm_load_si128((vuint8 *)&dilatation1[i-3][j+1]);
			d2b2 = _mm_load_si128((vuint8 *)&dilatation1[i-2][j+1]);
			d2c2 = _mm_load_si128((vuint8 *)&dilatation1[i-1][j+1]);
			...
			_mm_store_si128((vuint8 *)&dilatation2[i-2][j], s);
		...
		// Erosion 2
		e2c0 = _mm_load_si128((vuint8 *)&dilatation2[i-2][-1]);
		e2c1 = _mm_load_si128((vuint8 *)&dilatation2[i-2][0]);
		for (j = 0; j < n; j++) {
			e2a2 = _mm_load_si128((vuint8 *)&dilatation2[i-4][j+1]);
			e2b2 = _mm_load_si128((vuint8 *)&dilatation2[i-3][j+1]);
			e2c2 = _mm_load_si128((vuint8 *)&dilatation2[i-2][j+1]);
			...
			_mm_store_si128((vuint8 *)&img_dst[i-2][j], s);
